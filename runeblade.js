...
Artefacts['Samadun Runic Stone'] = {'order': 2, 'name': 'Samadun Runic Stone', 'weight': 1, 'maxLevel': 0, 'costFactor': 'Linear-1', 'effectFactor': 20, 'effectBaseValue': 0, 'costLevelModifier': 0, 'effectLabel': 'DPS Attack Bonus', 'effectPreSymbol': '', 'effectPostSymbol': '%' };
...
Artefacts['Nocri Orb of Teleportation'] = {'order': 6, 'name': 'Nocri Orb of Teleportation', 'weight': 1, 'maxLevel': 0, 'costFactor': 'Nocri-1.5', 'effectFactor': 1, 'effectBaseValue': 1, 'costLevelModifier': 0, 'effectLabel': 'Starting Level', 'effectPreSymbol': '', 'effectPostSymbol': '' };
...
Artefacts['Cursed Divining Rod'] = {'order': 15, 'name': 'Cursed Divining Rod', 'weight': 1, 'maxLevel': 6, 'costFactor': 'Exponential-3', 'effectFactor': 1, 'effectBaseValue': 0, 'costLevelModifier': 0, 'effectLabel': 'Chests Detected', 'effectPreSymbol': '', 'effectPostSymbol': '' };
...
Artefacts['Fury Goader'] = {'order': 21, 'name': 'Fury Goader', 'weight': 1, 'maxLevel': 90, 'costFactor': 'Exponential-2', 'effectFactor': 1, 'effectBaseValue': 0, 'costLevelModifier': 0, 'effectLabel': 'Critical Hit Probability', 'effectPreSymbol': '', 'effectPostSymbol': '%' };
...
function initializePage()
{
  ...
  for (var artefactName in Artefacts)
  {
    ...
    artefactDiv.innerHTML = '<div class="div-table-col-label">' + artefactObject['name'] + '</div>';
