...
Artefacts['Nocri Orb of Teleportation'] = {'order': 6, 'name': 'Nocri Orb of Teleportation', 'weight': 1, 'maxLevel': 0, 'costFactor': 'Nocri-1.5', 'effectFactor': 0, 'effectBaseValue': 0, 'costLevelModifier': 0, 'effectLabel': 'Mysterious Effect', 'effectPreSymbol': '', 'effectPostSymbol': '', 'url': 'http://runeblade.wikia.com/wiki/Nocri_Orb_of_Teleportation' };
...
Artefacts['Fury Goader'] = {'order': 21, 'name': 'Fury Goader', 'weight': 1, 'maxLevel': 90, 'costFactor': 'Exponential-2', 'effectFactor': 1, 'effectBaseValue': 0, 'costLevelModifier': 0, 'effectLabel': 'Crytical Hit probability', 'effectPreSymbol': '', 'effectPostSymbol': '%', 'url': 'http://runeblade.wikia.com/wiki/Fury_Goader' };
